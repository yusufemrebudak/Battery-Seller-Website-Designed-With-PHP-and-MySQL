...
<head> 
    ...
    <meta name="description" content="Özel üretim AGM akülerin fiyatları Amir Akü farkıyla en makul fiyata indirilmiştir.İster Kapıya Servis ister şubelerimize gelip değişim işlemi gerçekleştirebilirsiniz.">
    <meta name="author" content="Inovatik">
    <title>80Ah AGM Akü Fiyatları| Aküm Burada</title>
	...
	<div  class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<h2>80 Amper AGM AKÜ FİYATLARI<br> <!-- That Suits Your Needs --></h2>
			</div> <!-- end of col -->
		</div> <!-- end of row -->
		<div class="row">
			<div class="col-lg-12">
					...
					<div  class="card ">
						...
						<div class="card-body ">
							...
							<ul class="list-unstyled li-space-lg">
								...
								<li class="media">
									<i class="fas fa-square"></i>
									<div class="media-body"><?php echo $uruncek['urun_icerik_3'] ?>
									</div>
								</li>
							</ul>
			...
			<h4>Önemli Not : Tüm akülerin fiyatları aynı amper eski akü iadeli fiyatlardır!</h4>
				<a class="btn-outline-reg back" href="start-stop-efb-agm-aku-fiyatlari">GERİ DÖN</a>

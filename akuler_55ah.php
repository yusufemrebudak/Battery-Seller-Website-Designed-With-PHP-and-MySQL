...
<head> 
    ...
    <meta name="description" content="55 Amper aküler genellikle Japon tipi araç aküleridir.En uygun fiyatları tek bir sayfada derledik-KAPIYA SERVİS HİZMETİ">
    <meta name="author" content="Inovatik">
    <title>55 Amper DAR Akü Fiyatları | Aküm Burada</title>
	...
	<div  class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<h2>55-60 AMPER DAR AKÜ FİYATLARI<br> <!-- That Suits Your Needs --></h2>
			</div> <!-- end of col -->
		</div> <!-- end of row -->
		<div class="row">
			<div class="col-lg-12">

...
<head> 
    ...
    <meta name="description" content="45 Amper aküler genellikle Japon tipi araçların aküleridir.Tek tıklamayla fiyatlara ulaşabilirsiniz-KAPIYA SERVİS HİZMETİ">
    <meta name="author" content="Inovatik">
    <title>45 Amper DAR Akü Fiyatları | Aküm Burada</title>
	...
	<div  class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<h2>45 AMPER AKÜ FİYATLARI<br> <!-- That Suits Your Needs --></h2>
			</div> <!-- end of col -->
		</div> <!-- end of row -->
		<div class="row">
			<div class="col-lg-12">

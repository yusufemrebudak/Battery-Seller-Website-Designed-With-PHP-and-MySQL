...
<meta name="description" content="EFB Aküler start-stop özellikli araçlar için özel olarak üretilmiştir - 60 Amper EFB Akü Fiyatlarına tek tıklamayla ulaşabilirsiniz.">
	...
	<div  class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<h2>60-63 Amper EFB AKÜ FİYATLARI<br> <!-- That Suits Your Needs --></h2>
			</div> <!-- end of col -->
		</div> <!-- end of row -->
		<div class="row">
			<div class="col-lg-12">

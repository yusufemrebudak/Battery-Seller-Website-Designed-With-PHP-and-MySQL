...
<head> 
    ...
    <meta name="description" content="Sizin için akünün arızalı olduğunu gösteren en sık 8 işareti derledik bu yazımızı okuduktan sonra akünüzün sağlam mı yoksa arızalı olduğunu anlayacaksınız.">
    <meta name="author" content="Inovatik">
    <title>Akü Ömrünün Bittiğini Gösteren 8 İşaret|Aküm Burada</title>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="list-unstyled li-space-lg indent">
                                ...
                                <li class="media">
                                    <i style="font-size: 18px" class="fas fa-arrow-right"></i>
                                    <div class="media-body"><?php echo $aku_soru_cek['aku_cevap_madde8'] ?></div>
                                </li>

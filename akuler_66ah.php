...
<head> 
    ...
    <meta name="description" content="66 Amper Aküler alçak tip akü sınıfına girer-En uygun fiyatlarla-İster kapınıza getirelim ister şubelerimizi ziyaret ederek akü değişim işlemini gerçekleştirebilirsiniz.">
    <meta name="author" content="Inovatik">
    <title>66 Amper ALÇAK Akü Fiyatları | Aküm Burada</title>
	...
	<div  class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<h2>66 AMPER (ALÇAK) AKÜ FİYATLARI<br> <!-- That Suits Your Needs --></h2>
			</div> <!-- end of col -->
		</div> <!-- end of row -->
		<div class="row">
			<div class="col-lg-12">

...
<head> 
    ...
    <meta name="description" content="90Ah aküler daha çok kamyonet tarzı araçlara takılır.Tek tıkla fiyatları öğrenebilir ve bizi arayarak detaylı bilgi alabilirsiniz.">
    <meta name="author" content="Inovatik">
    <title>90 Ah Akü Fiyatları | Aküm Burada</title>
	...
	<div  class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<h2>90 AMPER AKÜ FİYATLARI<br> <!-- That Suits Your Needs --></h2>
			</div> <!-- end of col -->
		</div> <!-- end of row -->
		<div class="row">
			<div class="col-lg-12">

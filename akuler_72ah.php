...
<meta name="description" content="72 Amper akü fiyatlarını en uygun fiyatlarla sunuyoruz.Bursa'da en uygun fiyatlı aküleri ister kapınıza getirelim ister şubelerimizden temin edebilirsiniz.">
	...
	<div  class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<h2>72 AMPER AKÜ FİYATLARI<br> <!-- That Suits Your Needs --></h2>
			</div> <!-- end of col -->
		</div> <!-- end of row -->
		<div class="row">
			<div class="col-lg-12">

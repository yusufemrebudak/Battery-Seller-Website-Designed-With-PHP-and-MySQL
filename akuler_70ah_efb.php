...
<head> 
    ...
    <meta name="description" content="EFB aküler standart araç akülerinden farklı donanımlarda üretilmiştir.Start-stop araçlara uyumludur-70Ah EFB Akü Fiyatlarımız.">
    <meta name="author" content="Inovatik">
    <title>70-72Ah EFB Akü Fiyatları | Aküm Burada</title>
	...
	<div  class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<h2>70-72 Amper EFB AKÜ FİYATLARI<br> <!-- That Suits Your Needs --></h2>
			</div> <!-- end of col -->
		</div> <!-- end of row -->
		<div class="row">
			<div class="col-lg-12">

...
<head> 
	...
	<meta name="description" content="AGM Aküler standart akülerden farklı olarak Start-stop araçlar için özel olarak üretilmiştir-AGM Akü Fiyatlarını görün-Bizi Arayın Kapınıza Getirelim.">
	<meta name="author" content="Inovatik">
	<title>70 Ah AGM Akü Fiyatları | Aküm Burada</title>
	...
	<div  class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<h2>70 Amper AGM AKÜ FİYATLARI<br> <!-- That Suits Your Needs --></h2>
			</div> <!-- end of col -->
		</div> <!-- end of row -->
		<div class="row">
			<div class="col-lg-12">

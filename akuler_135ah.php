...
<head> 
    ...
    <meta name="description" content="İster kapınıza getirelim-ister şubelerimizi ziyaret ederek akü değişim işlemini gerçekleştirebilirsiniz-135 Amper Akü Fiyatlarına tek tıklama ile ulaşabilirsiniz.">
    <meta name="author" content="Inovatik">
    <title>135 Amper Akü Fiyatları | Aküm Burada</title>
	...
	<div  class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<h2>105 AMPER AKÜ FİYATLARI<br> <!-- That Suits Your Needs --></h2>
			</div> <!-- end of col -->
		</div> <!-- end of row -->
		<div class="row">
			<div class="col-lg-12">

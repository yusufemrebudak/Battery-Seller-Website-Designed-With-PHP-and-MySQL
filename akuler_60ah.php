...
<head>
	...
	<meta name="description" content="60 Amper Akü fiyatlarımıza tek tıklama ile ulaşabilirsiniz.Bizleri arayarak detaylı bilgi ve KAPIYA SERVİS hizmeti alabilirsiniz.">
	...
	<div  class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<h2>60 AMPER AKÜ FİYATLARI<br> <!-- That Suits Your Needs --></h2>
			</div> <!-- end of col -->
		</div> <!-- end of row -->
		<div class="row">
			<div class="col-lg-12">

...
<meta name="description" content="AGM Aküler start-stop özellikli araçlar için özel olarak üretilmiştir - 60 Amper AGM Akü Fiyatlarına ulaşabilirsiniz.">
	...
	<div  class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<h2>60 Amper AGM AKÜ FİYATLARI<br> <!-- That Suits Your Needs --></h2>
			</div> <!-- end of col -->
		</div> <!-- end of row -->
		<div class="row">
			<div class="col-lg-12">

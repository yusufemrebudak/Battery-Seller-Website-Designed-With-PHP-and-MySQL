...
<head> 
    ...
    <meta name="description" content="50 Amper Akü Fiyatlarına tek tıklama ile ulaşabilirsiniz-İster kapınıza getirelim ister şubelerimizi ziyaret ederek akü değişim işlemini gerçekleştirebilirsiniz.">
    <meta name="author" content="Inovatik">
    <title>50 Amper KARE Akü Fiyatları | Aküm Burada</title>
	...
	<div  class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<h2>50 AMPER (KARE) AKÜ FİYATLARI<br> <!-- That Suits Your Needs --></h2>
			</div> <!-- end of col -->
		</div> <!-- end of row -->
		<div class="row">
			<div class="col-lg-12">
